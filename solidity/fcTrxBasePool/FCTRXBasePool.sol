...
contract FCTRXBasePool is LPTokenWrapper, IRewardDistributionRecipient {
    ITRC20 public fcToken = ITRC20(0x6df775169df9b44a51Cd4C1388E83192F482bCBe);  //FC
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (trueReward > 0) {
            ...
            fcToken.safeTransfer(msg.sender, trueReward);
    ...
    */
    ...
    onlyOwner
    {
        require(to_ != address(0), "must not 0");
        require(amount_ > 0, "must gt 0");
        require(token_ != fcToken, "must not fcToken");
