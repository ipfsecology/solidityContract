...
contract FCTTRXBasePool is LPTokenWrapper, IRewardDistributionRecipient {
    ITRC20 public fctToken = ITRC20(0x51D222625b16f45cD232C8aF41A27E0F47CdfA56);  //FCT
    uint256 public constant DURATION = 63_072_000;// 365 * 2 day
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (trueReward > 0) {
            ...
            fctToken.safeTransfer(msg.sender, trueReward);
    ...
    */
    ...
    onlyOwner
    {
        require(to_ != address(0), "must not 0");
        require(amount_ > 0, "must gt 0");
        require(token_ != fctToken, "must not fctToken");
